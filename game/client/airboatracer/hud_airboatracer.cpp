...
CHudAirboatRacer::CHudAirboatRacer(const char *pElementName) : CHudElement(pElementName), BaseClass(NULL, "HudAirboatRacer")
{
	...
	surface()->DrawSetTextureFile(m_nPowerup3, "sprites/hud/infinity", true, true);
...
void CHudAirboatRacer::Paint()
{
	...
	const char *pszLabelPowerup = "POWERUP", *pszLabelLap = "LAP", *pszLabelSpeed = "SPEED", *pszValueSpeed = sSpeed;
